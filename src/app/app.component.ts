...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Clientes', component: ListclientsPage },
      { title: 'Crear Cliente', component: CreateClientPage },
      { title: 'Crear Punto de Venta', component: CreateSalePointView_1Page},
      { title: 'Check Personal', component: CheckStaffPage},
      { title: 'Check Activos', component: CheckActivoPage},
    ];
